...
namespace nTools.SqlTools.Archives
{
    ...
    /// </summary>
    /// <type>class</type>
    public class MySqlClass : ISqlClass
    {
        #region fields
        //global variables
        ...
        {
            get { return this.mySqlQuery.CommandText; }
            set { }
        }
        public bool IsConnected
        {
        ...
        public int RowCount { get { return getRows(); } }
        public int ColumnCount { get { return getColumns(); } }
        ...
        /// <param name="pass">(string)</param>
        /// <param name="db">(string)</param>
        public bool setConn(string server, int port, string userId, string pass, string db)
        {
            connStr = "SERVER=" + server + ";PORT=" + port.ToString() + ";UID=" + userId + ";PASSWORD=" + pass + ";DATABASE=" + db + ";";
            System.Console.WriteLine(connStr);
            try
        ...
        /// <param name="userId">(string)</param>
        /// <param name="pass">(string)</param>
        public bool setConn(string server, string userId, string pass)
        {
            connStr = "SERVER=" + server + ";UID=" + userId + ";PASSWORD=" + pass + ";";
            System.Console.WriteLine(connStr);
            try
        ...
        /// <param name="userId">(string)</param>
        /// <param name="pass">(string)</param>
        public bool setConn(string server,int port, string userId, string pass)
        {
            connStr = "SERVER=" + server + ";PORT=" + port.ToString() + ";UID=" + userId + ";PASSWORD=" + pass + ";";
            System.Console.WriteLine(connStr);
            try
        ...
        */
        ...
        public DataTable getSchema()
        {
            if (this.isConnected())
            {
                return this.mySqlReader.GetSchemaTable();
            }
            else
            {
        ...
        public DataSet getDataSet()
        {
            if (this.isConnected())
            {
                try
                {
                    MySqlDataAdapter da = new MySqlDataAdapter(this.mySqlQuery.CommandText, this.connStr);
        ...
        */
        ...
        {
            MySqlClass tmp = MySqlClass.makeCopyOf(this);
            tmp.query(this.QueryString);

            int rowMax = tmp.mySqlReader.FieldCount;
            SqlRow row;
            ...
            do
            {
                ...
                {
                    row.setKey(x, tmp.mySqlReader.GetName(x));
